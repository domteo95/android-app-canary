...
//        }
    ...
    fun listColors(): ArrayList<Int> {
        ...
        listColors.add(resources.getColor(R.color.color4))
        listColors.add(resources.getColor(R.color.color5))
        listColors.add(resources.getColor(R.color.color6))
        listColors.add(resources.getColor(R.color.color7))
        listColors.add(resources.getColor(R.color.color8))
